...
class Reservation(models.Model) : 
    ...
    use_kind = models.ForeignKey('UseKind',verbose_name='目的',on_delete=models.CASCADE)
    man_in = models.PositiveIntegerField("市内男性人数")
    man_out = models.PositiveIntegerField("市外男性人数")
    woman_in = models.PositiveIntegerField("市内女性人数")
